 ...
 * Created by yuxin.
 * Created time 2016/10/16 0016 下午 1:28.
 * Version   1.0;
 * Describe :
 * History:
 * ==============================================================================
...
//                    fragment.onStart(); // 启动目标tab的onStart()
    ...
    private FragmentTransaction obtainFragmentTransaction(int index){
        ...
        // 设置切换动画
        if(index > currentTab){
            ft.setCustomAnimations(R.anim.anim_in_right_left, R.anim.anim_out_right_left);
        }else{
            ft.setCustomAnimations(R.anim.anim_in_left_right, R.anim.anim_out_left_right);
        }
        return ft;
    }
